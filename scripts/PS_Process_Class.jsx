...
function CallIndesign(){
    ...
    var scriptToLoad = new File( "C:/Adobe/scripts/ID_Class.jsx" );
...
function GlobalVariables() {
	...
	strCopyright = localize( "$$$/JavaScripts/ImageProcessor/Copyright=Return by:" );
	strCopyrightHelp = localize( "$$$/JavaScripts/ImageProcessor/CopyrightHelp=Pick an online return date" );
	strWatermark = localize( "$$$/JavaScripts/ImageProcessor/Watermark=Return by:" );
	strWatermarkHelp = localize( "$$$/JavaScripts/ImageProcessor/WatermarkHelp=Pick a return to school date" );
...
function ImageProcessor() {
	...
	this.CreateDialog = function() {
		...
		d.stCopyrightInfo = l.grpCopyright.add( 'statictext', undefined, 'Online by' );
		d.stCopyrightInfo.helpTip = 'Set an online return by date';
		...
		d.etCopyrightInfo.helpTip = 'Set an online return by date';
...
///////////////////////////////////////////////////////////////////////////////
function GetDefaultParamsFile() {    
    return ( new File( "C:/Adobe/settings/ProcessClass.xml" ) );
